<template>
    <div>
        <div class="jumbotronmobile">
            ...
            <div class="jumbotronmobile__top">
                <div class="jumbotronmobile__topname">
                    <figure>
                        <img src="@/assets/imgs/REBELLION.png"/>
                    </figure>
                </div>
                <div class="jumbotronmobile__topburger" @click="togglemenu">
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
...
<style scoped lang="scss">
  ...
  .jumbotronmobile {
      ...
      &__top {
          ...
          left: 0;
          width: 100vw;
          padding: #{scaleValue(75)} #{scaleValue(75)};
      ...
      &__topname {
          ...
          transform: translateX(#{scaleValue(-162)}) translateY(#{scaleValue(-95)});
